        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            <p className="text-xs text-neutral-400">
              ...
              <a className="text-xs underline hover:text-neutral-300 hover:decoration-2 focus:decoration-2 focus:outline-hidden" href="https://huffmanks.com" target="_blank" rel="noopener">
                Kevin Huffman
              </a>
            </p>
          </div>
